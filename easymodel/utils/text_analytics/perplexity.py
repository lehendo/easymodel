...
# Enhanced perplexity computation for predictions
def compute_perplexity_from_predictions(predictions, tokenizer):
    """
    Compute perplexity from model predictions.
...
# Function to compute perplexity for multiple texts
def compute_batch_perplexity(model, tokenizer, texts, max_length=512):
    """
    ...
    Returns:
        list: Perplexity scores for each text
    """
    perplexities = []
